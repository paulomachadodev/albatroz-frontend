...
@Component({
  ...
  imports: [],
  template: `
    <div class="fixed left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-4
                z-[100] flex flex-col gap-3 w-[calc(100vw-2rem)] max-w-xs sm:w-full sm:max-w-sm pointer-events-none"
